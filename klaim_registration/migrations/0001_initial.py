    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_kk', models.FileField(blank=True, null=True, upload_to='tk/kk/', validators=[django.core.validators.RegexValidator('.*\\.(jpg|JPG|JPEG|pdf|PDF)', 'Only Support PDF dan JPG')])),
                ('file_ktp', models.FileField(blank=True, null=True, upload_to='tk/ktp/', validators=[django.core.validators.RegexValidator('.*\\.(jpg|JPG|JPEG|pdf|PDF)', 'Only Support PDF dan JPG')])),
                ('file_paklaring', models.FileField(blank=True, null=True, upload_to='tk/paklaring/', validators=[django.core.validators.RegexValidator('.*\\.(jpg|JPG|JPEG|pdf|PDF)', 'Only Support PDF dan JPG')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('url_uuid', models.UUIDField(default=uuid.UUID('64012055-382b-4cd7-82ed-d917e66e241a'), editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('no_kpj', models.CharField(blank=True, max_length=11, null=True)),
                ('tgl_keps', models.DateField(blank=True, null=True)),
